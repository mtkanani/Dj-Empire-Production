...
export default function CustomerLogin() {
  ...
  return (
    <AuthLayout title="Platform Sign In" subtitle="Sign in to your customer, organizer, or admin account" badgeText="Unified Authentication">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <LoadingButton loading={loading}>Sign In to Platform</LoadingButton>
